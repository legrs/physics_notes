...
=== Magnetization
- *magnetization* - the phenomen of being polarized into N ans S by magnetic field.

#v(0.5em)

- *ferromagnet* - substances which are magnetized strongly.
- *paramagnet* - substances which are magnetized slightly.
- *diamagnet* - substances which are magnetized in the reverse direction.
