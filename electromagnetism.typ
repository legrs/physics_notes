  ...
  #place(center + horizon)[
    #cetz.canvas({
      ...
      ortho(x:20deg, y:130deg,{
        ...
        line((0,-r,v_x*calc.pi*2),(0,-r -0.6,v_x*calc.pi*2))
        line((0,-r,v_x*calc.pi*2*5),(0,-r -0.6,v_x*calc.pi*2*5))
        line((0,-r -0.4,v_x*calc.pi*2),(0,-r -0.4,v_x*calc.pi*2*5),mark:(start:">",end:">",fill:black))
        content((0,-r  -1, v_x*calc.pi*2*3),$bold(l)$)
      })
    })
  ]
])
...
When a charged particle($q$) is moving in magnetic field $bb(B)$
$bb(F) = bb(I) times bb(B) l\
quad = bb(v) times bb(B) q n s l quad(because bb(I) = q n s bb(v))\
$

There are $n S l$ particles in the wire. ( $n,S,l$ is definited as same as @ohm ).

Thus, 

$bb(f) = (q n S bb(v)) times bb(B) dot l / ( n S l )\
  ...
  #place(center + horizon)[
    #cetz.canvas({
      ...
      ortho(x:15deg, y:100deg,{
        ...
        line((1,0,-1.8),(1,2.5,-1.8),mark:(start:">",fill:black))
...
#align(center,box(width:17cm, height:7cm, clip:true)[
  #place(center + horizon)[
    #cetz.canvas({
      ...
      content((0,2.8),$bold(+)$)
      line((0.5,3),(1,3))
      line((0.8,3),(0.8,-3),mark:(start:">" ,fill:black))
  ...
  #place(center + horizon)[
    #cetz.canvas({
      ...
      ortho(x:15deg, y:100deg,{
        ...
        line((0,0,0),(0,2,0),mark:(end:">",fill:blue),stroke:(paint:blue,thickness:0.1))
      ...
      ortho(x:15deg, y:100deg,{
        ...
        line((0,-1,0),(0,3,0),mark:(end:">",fill:blue),stroke:(paint:blue,thickness:0.1))

        line((1,0,0),(1,0,-2))
        line((1,2.5,0),(1,2.5,-2))
        line((1,0,-1.8),(1,2.5,-1.8),mark:(end:">",fill:black))
        content((1,2.5/2 ,-2.2),$bold(V)$)
      })
...
$
$
  bold(I_L = I_(L 0) sin omega T quad <=> quad V_L = I_(L 0) X_L cos omega t)
$
...
quad med med = C dot (d V_C)/(d t)\
quad med med = C omega V_(C 0) cos omega t\
$

Here, Set $I_C = I_(C 0) sin omega t$,

$V_C = - I_(C 0) X_C cos omega t$
